...
- [raw](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/raw): reserved for optional raw snapshots if you later decide to persist downloaded source tables locally.
- [processed](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/processed): aligned modeling-ready exports that keep raw missing values.
- [artifacts](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/artifacts): profiling results, label-mapping records, mapping candidates, shared-feature lists, and dropped-feature reports.

## Scripts

- [01_fetch_and_profile.py](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/01_fetch_and_profile.py): download UCI datasets `336` and `857`, print audit summaries, and save profiling artifacts.
- [02_define_labels.py](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/02_define_labels.py): inspect raw target values and save exact binary label mappings.
- [03_feature_mapping_template.py](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/03_feature_mapping_template.py): generate feature-alignment candidates for manual review.
- [04_export_aligned_datasets.py](C:/Users/User/Desktop/小楊機密/碩士論文/最重要論文檔/CKD-main/data/04_export_aligned_datasets.py): export aligned raw datasets after you create `artifacts/feature_mapping_confirmed.csv`.
